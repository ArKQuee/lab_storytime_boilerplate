...
function sweetTooth(totalSweets, sweetsEatenbyKaren, sweetsPerMeter, metersTravelled) {
    let remainingSweets = totalSweets - sweetsEatenbyKaren - (sweetsPerMeter * metersTravelled);
...
function consoleKaren(...strategies){
    let concatenatedStrategies = strategies.join(' ');
    return concatenatedStrategies.length;
}